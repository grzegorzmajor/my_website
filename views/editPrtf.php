<main class="main_new_prtf">
    <form class="form_new_prtf" action="/?action=updatePrtf<?php $id = $_GET['id'];
        ...
        <label class="form_new_prtf_label">Opis<textarea class="form_new_prtf_text" name="description"><?php
                                                                                                        $data = str_replace('""', '"', $dataList['descr']) ?? null;
    ...
    <form class="form_new_prtf" action="/?action=updateFotoPrtf<?php $id = $_GET['id'];
                                                                echo "&id=$id"; ?>" method="post" enctype="multipart/form-data">
        <h2>Zmień zdięcie.</h2>
