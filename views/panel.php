<main class="main_login">
    <form action="/?action=logout" method="post" class="form_login"> 
        <button  class="form_login_button" type="submit">WYLOGUJ!</button>
    </form>
    <div class="main_new_prtf">
        ...
        <form class="form_new_prtf" action="/?action=addAboutMe" method="post" >        
